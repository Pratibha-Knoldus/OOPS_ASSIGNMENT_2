...
object Person {
  def main(args: Array[String]): Unit = {
    val person = new Person("Aish",21)
    val person1 = new Person("Aish",65)
    val person2 = new Person("Radha",22)
    val person3 = new Person("Radha",65)
    val person4 = new Person("Ramesh",69)
